...
const PREGUNTAS = [
  ...
  {
    t: '¿Por qué los humedales son llamados "riñones del planeta"?',
    ops: ['Porque tienen forma de riñón', 'Porque filtran y purifican el agua contaminada', 'Porque producen minerales', 'Porque solo viven animales acuáticos'],
    r: 1, f: '¡Correcto! Los humedales filtran contaminantes del agua igual que los riñones filtran la sangre.'
  },
  {
    t: '¿Cuál es la principal causa de degradación de los humedales bogotanos?',
    ops: ['El turismo excesivo', 'Los terremotos frecuentes', 'La expansión urbana y relleno ilegal', 'El cambio de temperatura'],
    r: 2, f: '¡Correcto! La expansión urbana y el relleno ilegal han destruido más del 90% de los humedales originales de Bogotá.'
  },
  {
    t: '¿Qué animal es considerado bioindicador de la calidad del agua en humedales?',
    ops: ['El cóndor andino', 'La rana', 'El oso de anteojos', 'El venado'],
    r: 1, f: '¡Correcto! Las ranas son bioindicadores: su presencia señala que el ecosistema acuático está saludable.'
  },
  {
    t: '¿Qué significa que la Tingua Bogotana esté "en peligro crítico"?',
    ops: ['Que es peligrosa para los humanos', 'Que enfrenta alto riesgo de extinción', 'Que vive en zonas de alto peligro', 'Que está protegida por el ejército'],
    r: 1, f: '¡Correcto! "En peligro crítico" es la categoría más alta de amenaza antes de la extinción en la Lista Roja de la UICN.'
  },
  {
    t: '¿Qué porcentaje del agua dulce accesible del planeta está en ríos y humedales?',
    ops: ['Menos del 1%', 'El 10%', 'El 25%', 'El 50%'],
    r: 0, f: '¡Correcto! Menos del 1% del agua dulce disponible está en ríos y humedales, ¡por eso son tan valiosos!'
  },
  {
    t: '¿Cómo ayudan los humedales a combatir el cambio climático además de almacenar carbono?',
    ops: ['Produciendo lluvia artificial', 'Regulando la temperatura local y purificando el aire', 'Generando energía solar', 'Atrayendo nubes de otras regiones'],
    r: 1, f: '¡Correcto! Los humedales regulan la temperatura, purifican el aire y reducen el efecto isla de calor urbano.'
  },
  {
    t: '¿Qué convenio internacional protege los humedales de importancia mundial?',
    ops: ['Protocolo de Kioto', 'Convenio de Ramsar', 'Acuerdo de París', 'Convenio de Estocolmo'],
    r: 1, f: '¡Correcto! El Convenio de Ramsar (1971) es el tratado internacional que protege los humedales de importancia mundial.'
  },
  {
    t: '¿Cuántos humedales de Bogotá están declarados como Parques Ecológicos Distritales?',
    ops: ['Solo 3', 'Todos los que quedan', 'Más de 10', 'Ninguno aún'],
    r: 2, f: '¡Correcto! Más de 10 humedales bogotanos están declarados Parques Ecológicos Distritales de Humedal.'
  },
  {
    t: '¿Qué pasa con las especies migratorias si los humedales desaparecen?',
    ops: ['Se adaptan fácilmente', 'Pierden sus sitios de descanso y alimentación, en riesgo de morir', 'Migran más rápido', 'No les afecta'],
    r: 1, f: '¡Correcto! Los humedales son escalas vitales en rutas migratorias; sin ellos, miles de aves mueren en el camino.'
  },
];
